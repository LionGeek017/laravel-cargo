                ...
                <div class="col-md-10">
                    <div>
                        <div class="mb-5 text-center">
                            ...
                            <p class="text-muted mb-0">Отредактируйте существующую подписку</p>
                        </div>
                        <span class="clearfix"></span>
                        <form role="form" class="border p-4" method="POST" action="{{ route('adminchik.subscriptions.update', ['subscription' => $post->id]) }}">
                            @csrf
                            @method('PATCH')
